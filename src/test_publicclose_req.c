/**
 * File name: test_publicclose_req.c
 *
...
int main(void) {
	...
	char transactionId[] = {"CloseRequest_TransactionId"};
	char globalSignature[] = {"MySignature"};

	message.abortOnError = 3;
	message.groupNo = 3;
	message.transactionId = transactionId;
	message.messageBody.choiceTag = SML_MESSAGEBODY_CLOSE_REQUEST;
	message.messageBody.choiceValue.closeRequest = &closeReq;
